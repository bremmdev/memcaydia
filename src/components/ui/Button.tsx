...
export default function Button(props: Props) {
  ...
  const classes = cn(
    "text-white flex justify-center bg-primary-teal px-4 py-2 w-fit rounded-md font-medium uppercase hover:bg-opacity-90 flex gap-2 items-center justify-center mx-auto",
    className
  );
